    ...
    return (
        <div className='flex justify-center items-center min-h-screen bg-[#f5f5f7]'>
            <Card className="w-full max-w-sm shadow-ambient border-[#f0f0f0]">
                <CardHeader>
                    <CardTitle className="font-display text-[#121212]">Create Your account</CardTitle>
                    <CardDescription className="font-body text-[#5c5c6d]">
                        Enter given details to create an account
                    </CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <CardFooter className="flex-col gap-2">
                    ...
                    <p className='text-[#5c5c6d] text-sm font-body'> Already have an account? <Link to={"/login"} className='hover:underline cursor-pointer text-[#1a237e] font-display font-medium'>Login</Link></p>
                </CardFooter>
            </Card>
        </div >
    )
